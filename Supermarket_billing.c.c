...
void main()
{
    ...
    {
        printf("=========================================================\n\n");
        printf("\t\t WELCOME TO PAVITRA SUPER MARKET \n\n");
        printf("=========================================================\n\n");
...
void manageProduct()
{
    ...
    {
        printf("=========================================================\n\n");
        printf("\t\t WELCOME MANAGER ARAVIND !!\n\n");
        printf("=========================================================\n\n");
...
snode* create_node(int id, char *name, int price, int qty)
{
    ...
    if(newnode==NULL)
    {
        printf("\nsorry products are not available:");
        return 0;
    }
    else
    {
...
void addProduct()
{
    ...
    printf("=========================================================\n\n");
    printf("\t\t ADD PRODUCTS TO STOCK !!\n\n");
    printf("=========================================================\n\n");
    char name[20],ch;
    printf("\nEnter the ID of the product to be added : ");
    scanf("%d", &id);
    ...
    scanf("%s", name);
    printf("\nEnter the price of the product to be added: ");
    scanf("%d", &price);
    printf("\nEnter the quantity of the product to be added: ");
    scanf("%d", &qty);
...
void checkout()
{
    ...
    for (ptr2 = first2;ptr2 != NULL;ptr2 = ptr2->next2)
    {
     ...
     if(total>=3000)
         {  
    printf("\t----------------!!!!CONGRAGULATIONS CUSTOMER!!!!!---------------------\n\n");
    printf("\t\tYou have won a celebrations pack from PAVITRA SUPER MARKET\t\t");
    printf("\n \t\t--------------Thanks for shopping!!!------------------\t\t");
